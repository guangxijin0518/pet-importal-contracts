const NFTItem = artifacts.require("PetImmortalToken");
const Engine = artifacts.require("Engine");
const helper = require('../utils/utils.js');

contract("PetImmortalToken Marketplace", accounts => {
  ...
  it("Should create nft", async () => {
    var tokenId = await instance.createItem("www.luispando.com", 200, "Hola 1", { from: owner });
  ...
  it("Should create 3rd nft", async () => {
    var tokenIdResponse = await instance.createItem("www.luispando2.com", 300, "hola 3", { from: owner });
  ...
  it("Should fail if royalties >= 900", async () => {
    try {
      var tokenId = await instance.createItem("www.luispando2.com", 9000, "hola 3", { from: owner });
    }
  ...
  it("Calc of minting cost", async () => {
    var receipt = await instance.createItem("www.luispando4.com", 1000, "hola 4", { from: accounts[0] });
    let gasUsed = receipt.receipt.gasUsed;
