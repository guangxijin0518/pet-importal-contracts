...
contract Engine is Ownable {
    ...
    function buy(uint256 _tokenId) external payable {
        ...
        PetImmortalToken asset = PetImmortalToken(offer.assetAddress);
    ...
    function createAuction(
        address _assetAddress, // address of the PetImmortalToken token
    ...
    function claimAsset(uint256 auctionIndex) public {
        ...
        PetImmortalToken asset = PetImmortalToken(auction.assetAddress);
